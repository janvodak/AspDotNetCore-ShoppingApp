...
namespace ShoppingApp.Services.Order.API.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20231224094748_POCODomainEntities")]
    partial class POCODomainEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShoppingApp.Services.Order.API.Domain.AggregatesModel.Order.Entities.OrderAggregateRoot", b =>
                {
                    b.OwnsOne("ShoppingApp.Services.Order.API.Domain.AggregatesModel.Address.AddressValueObject", "BillingAddress", b1 =>
                        {
                    ...
                    b.OwnsOne("ShoppingApp.Services.Order.API.Domain.AggregatesModel.Customer.CustomerValueObject", "Customer", b1 =>
                        {
                            b1.Property<int>("OrderAggregateRootId")
                                .HasColumnType("int");
